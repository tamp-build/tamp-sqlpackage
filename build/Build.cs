...
#pragma warning restore CS0649
    ...
    Target Test => _ => _
        ...
        .Executes(() => DotNet.Test(s => s
            .SetProject(RootDirectory / "tests" / "Tamp.SqlPackage.Tests" / "Tamp.SqlPackage.Tests.csproj")
            .SetConfiguration(Configuration)
            .SetNoBuild(true)
    ...
    Target Pack => _ => _
        ...
        {
            s.SetProject(RootDirectory / "src" / "Tamp.SqlPackage" / "Tamp.SqlPackage.csproj");
